    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            {/* Header */}
            <div className="flex items-center justify-between p-4 border-b bg-gradient-to-r from-orange-600 to-red-600 text-white rounded-t-2xl">
            ...
            <div className="p-4 bg-orange-50 border-b space-y-2">
              ...
              <p className="text-sm text-orange-800">
                <span className="font-semibold">Kasalungat:</span>{" "}
                {correctAnswer}
              </p>
              {lexiconData && (
            ...
            {/* Messages Area */}
            <div className="flex-1 overflow-y-auto p-4 space-y-4 scrollbar-thin scrollbar-thumb-orange-300 scrollbar-track-gray-100">
              {messages.length === 0 ? (
            ...
            <div className="p-4 border-t bg-gray-50 rounded-b-2xl">
              ...
              <p className="text-xs text-gray-500 mt-2 text-center">
                Press Enter to send • AI chat coming soon
              </p>
            </div>
          </motion.div>
        </>
