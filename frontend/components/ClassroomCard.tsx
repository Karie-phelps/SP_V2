...
const ClassroomCard = () => {
  return (
    ...
    >
      <DashboardCard className="p-0 overflow-hidden relative justify-end max-w-4xl w-full min-h-[15rem]">
        {" "}
        {/* Added min-h-[30rem] for a taller rectangular shape */}
        <Image
          src="/art/game-art-1.png"
