...
interface FillMissingCompletionModalProps {
  isOpen: boolean;
  score: number;
  correctCount: number;
...
export default function FillMissingCompletionModal({
  isOpen,
  score,
  correctCount,
  totalQuestions,
  onClose,
  onRetake,
}: FillMissingCompletionModalProps) {
                ...
                <div className="p-8 space-y-6 h-full flex flex-col">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-gray-600">
                      You've finished the fill missing words exercise.
                    </p>
                  </div>
