...
interface OrderingCompletionModalProps {
  isOpen: boolean;
  score: number;
  correctCount: number;
...
export default function OrderingCompletionModal({
  isOpen,
  score,
  correctCount,
  totalQuestions,
  ...
  const getPerformanceMessage = () => {
    if (score >= 90) return "🌟 Outstanding! Perfect sentence ordering!";
                ...
                <div className="p-8 space-y-6 h-full flex flex-col">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-gray-600">
                      You've finished the sentence ordering exercise.
                    </p>
                  </div>
